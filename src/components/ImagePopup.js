    ...
    return (
        ...
        <img src= {closeIcon} onClick={props.onClose} alt="" className="modal__close-button"/>
           <div className="modal__container">
            <img src={props.selectedCard && props.selectedCard.link}  alt="" className="modal__picture"/>
            <span className="modal__text-subtitle">{props.selectedCard && props.selectedCard.name}</span>
           </div>
      </div>
    )
}